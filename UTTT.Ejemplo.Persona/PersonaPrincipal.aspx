...
<body>
    <div class="container">
        ...
        <ContentTemplate>
            <input type="submit" name="btnTrick" value="" id="btnTrick" style="display: none;" />
                ...
                <asp:Label class="control-label col-sm-2" ID="lblNombre" runat="server" Text="Nombre:" Font-Size="medium"></asp:Label>
                 <div class="col-sm-2">
    ...
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="txtNombre" EventName="TextChanged" />
            ...
            <br />
            <div class="form-row" style="font-family: 'Oswald';">
                <asp:Label class="control-label col-sm-2" ID="lblSexo" runat="server" Text="Sexo:" Font-Size="medium"></asp:Label>
                <div class="col-sm-3">
            ...
            <div class="form-row" style="font-family: 'Oswald';">
                <asp:Label class="control-label col-sm-2" ID="Label2" runat="server" Text="Estado civil:" Font-Size="medium"></asp:Label>
                <div class="col-sm-3">
         ...
         <%--  <div class="form-row" style="font-family: 'Barlow Condensed Light'; font-weight: bold">
            ...
            <div style="font-family: 'Oswald'; font-weight: bold" align="left">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button CssClass="btn btn-outline-secondary" ID="btnBuscar" runat="server" Text="Buscar" align="center"
