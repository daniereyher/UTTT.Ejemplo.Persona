...
<body>
    ...
    <div class="container" align="center">
        <form id="form1" runat="server" class="form-horizontal">
            ...
            <div class="mb-3" style="font-size: Large; font-family: 'Oswald';" align="center">
            ...
            <div class="card" style="width: 23rem;" align="center">
                ...
                <div class="form-group" style="font-family: 'Oswald';" align="center">
                    <asp:Label ID="lblUsuario" runat="server" Text="Usuario:" Font-Size="Medium" Font-Bold="false"></asp:Label>
                ...
                <div class="form-group" style="font-family: 'Oswald';" align="center">
                    <asp:Label class="col-form-label" ID="lblPassword" runat="server" Text="Password:" Font-Size="Medium" Font-Bold="false"></asp:Label>
                ...
                <div style="font-family: 'Oswald'; font-weight: bold" align="center">
                    <asp:Button CssClass="btn btn-outline-success" ID="btnLogin" runat="server" Text="Iniciar sesión" align="center"
                        OnClick="btnLogin_Click" ViewStateMode="Disabled" Width="100px" />
                </div>
                <br />
                <div style="font-family: 'Oswald'; font-size: small" font-underline="True" align="center">
                    <a href="/PSR/RecuperarPassword.aspx" class="link-success">¿Ha olvidado su password?</a>
                </div>
